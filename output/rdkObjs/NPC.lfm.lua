...
local function constructNew_frmDZ_NPC_svg()
    ...
    obj.boxDetalhesDoItem3:setParent(obj);
    ...
    obj.rectangle1:setParent(obj.boxDetalhesDoItem3);
    ...
    obj.image1:setSRC("images/FichaNPC.png");
    ...
    obj.image2:setSRC("images/silhu.png");
